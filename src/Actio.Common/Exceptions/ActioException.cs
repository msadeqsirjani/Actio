...
namespace Actio.Common.Exceptions
{
    public class ActioException : Exception
    {
        ...
        public ActioException(string message, params object[] args) : this(null, message, args)
        {
        ...
        public ActioException(Exception innerException, string code, string message, params object[] args) : base(
